...
import { listMyOrder } from '../action/orderActions'
import { getUserDetail, updateUserProfile } from '../action/userAction'
...
const ProfileScreen = ({ location, history }) => {
    ...
    return <Row>
        ...
        <Col md={3}>
            ...
            {success && <Message variant="success">{name} Profile Updated</Message>}
            {loading && <Loader />}
